...
namespace implemented_Tema2
{
    ...
    public:
        Camera()
        {   
            /* // Set the initial position behind the tank
            position = glm::vec3(0, 2, -5); // Adjust the coordinates as needed

            // Set the initial orientation to look forward
            forward = glm::vec3(0, 0, 1); // Assuming the initial view is along the positive z-axis

            // Set the up vector (it's usually (0, 1, 0) for an upward orientation)
            up = glm::vec3(0, 1, 0);

            // Calculate the right vector based on the initial forward and up vectors
            right = glm::cross(forward, up);

            // Set the initial distance to the target (distance to the tank)
            distanceToTarget = 5.0f; // Adjust the distance as needed */
        }
/*
        Camera(const glm::vec3& position, const glm::vec3& center, const glm::vec3& up)
        {
            // position = camera position in xyz space
            // center = 
        ...
        */
        ...
        void TranslateForward(float distance)
        {
            ...
            // `MoveForward()`?
            const float speed = 2.0f; // Adjust this value to control the speed

            position += glm::normalize(forward) * distance * speed;
        }
        ...
        void TranslateUpward(float distance)
        {
            ...
            position += glm::normalize(up) * distance * speed;
        ...
        void TranslateRight(float distance)
        {
            ...
            position += glm::normalize(right) * distance * 2.0f;
